...
Download [iotjs-nuttx-20150430.tar.gz](https://github.com/Samsung/iotjs/blob/wikiattach/iotjs-nuttx-20150430.tar.gz?raw=true) file to harmony folder.

```
cd harmony
# assume you already copied to this folder
tar xvf iotjs-nuttx-20150430.tar.gz
cd nuttx
git checkout -b iotjs 2eba8afab5e8bdc32a0f6365de070eaa7f383149
patch -p1 < ../iotjs-nuttx-20150430.patch
```
